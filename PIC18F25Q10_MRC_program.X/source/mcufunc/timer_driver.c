...
/**************************************************************/
void td_g_cwg1_mode_full_bridge_drive_dir_set( u8 u8_dir_req )
{
    u8 u8_data_buff;
    ...
    /* CWG PWM変調受付 選択  */
    /*======================*/
    CWG1STR = (u8)0x0F;             /* CWGA, CWGB, CWGC, CWGD をPWM変調受付状態にする */
...
/**************************************************************/
/*  Function:                                                 */
/*  CWG1 Full-Bridge モード ブレーキ設定関数                    */
/*  ブラシモータ用ロジック 下側FETを同時ONでブレーキ設定する      */
/**************************************************************/
void td_g_cwg1_mode_full_bridge_brake( void )
{
    ...
    /* レジスタ更新 */
    CWG1STR = (u8)0xA0;             /* CWGD, CWGB をベタONする */
}
